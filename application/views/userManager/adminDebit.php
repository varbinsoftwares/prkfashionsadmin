    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title">Credit Debits</h3>
                    </div>
                    <div class="box-body">
                        <div ng-if="userobj.email">
                            ...
                            <form action="#" method="post" >
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-5 control-label">Enter Debits</label>
                                        <div class="col-sm-7">
                                            <input type="number" min="0" class="form-control price_tag_text" id='credit' name="credit"  aria-describedby="emailHelp" placeholder="" value="" max="{{userobj.credits-userobj.debits}}"> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary " name="allot_credit">Debit Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
